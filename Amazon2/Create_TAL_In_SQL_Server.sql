...
REP_NUM CHAR(2)
CONSTRAINT [FK_Customer_Rep] FOREIGN KEY ([REP_NUM]) REFERENCES [dbo].[REP] ([REP_NUM]) );
CREATE TABLE ORDERS
(ORDER_NUM CHAR(5) PRIMARY KEY,
ORDER_DATE DATE,
CUSTOMER_NUM CHAR(3) 
CONSTRAINT [FK_Orders_Customer] FOREIGN KEY ([CUSTOMER_NUM]) REFERENCES [dbo].[CUSTOMER] ([CUSTOMER_NUM]) );
CREATE TABLE ITEM
...
CONSTRAINT [FK_Order_Line_Item] FOREIGN KEY ([ITEM_NUM]) REFERENCES [dbo].[ITEM] ([ITEM_NUM]) );
INSERT INTO REP
VALUES
